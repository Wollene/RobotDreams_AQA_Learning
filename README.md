...
- [ ] Workshop: Creating Your own Framework for API Testing
- [ ] UI Testing Basics
- [ ] Cypress та Puppeteer
- [ ] Selenium WebDriver та WebDriver IO
- [ ] Playwright as an E2E Web UI Testing Framework
- [ ] Workshop: Writing Tests for Playwright Using PageObjects and WebElements
- [ ] BDD. Gherkin. Cucumber.js
- [ ] Writing Reports
- [ ] CI/CD in Automated Testing
- [ ] Introduction to Docker for Testing
- [ ] AI Tools
- [ ] Final Project
